    ...
    <ng-container *ngIf="isAuthenticated(); else authOnly">
      <div class="app-shell" [class.sidebar-collapsed]="isSidebarCollapsed">
        <aside class="sidebar">
          ...
          <nav class="nav">
            <a routerLink="/dashboard" routerLinkActive="active" *ngIf="hasModule('dashboard')">
            ...
            <a routerLink="/users" routerLinkActive="active" *ngIf="hasModule('users')">
              <span class="nav-icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
            ...
            <a routerLink="/role-modules" routerLinkActive="active" *ngIf="hasModule('role-modules')">
              <span class="nav-icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M12 2C7.58172 2 4 5.58172 4 10C4 11.9233 4.67845 13.6882 5.8089 15.0693L4.38794 18.9142C4.25739 19.2684 4.3569 19.6663 4.63263 19.94C4.90836 20.2138 5.30692 20.3106 5.6602 20.1766L9.35321 18.7866C10.1929 19.0817 11.0823 19.2435 12 19.2435C16.4183 19.2435 20 15.6618 20 11.2435C20 6.82518 16.4183 2 12 2ZM5.5 10C5.5 6.41015 8.41015 3.5 12 3.5C15.5899 3.5 18.5 6.41015 18.5 10C18.5 13.5899 15.5899 16.5 12 16.5C11.1216 16.5 10.2706 16.3332 9.47318 16.0047C9.29164 15.9299 9.08918 15.9224 8.90277 15.9926L6.30288 16.9707L7.30277 14.2698C7.38651 14.0436 7.34172 13.789 7.18484 13.6025C6.12073 12.3362 5.5 10.7132 5.5 10ZM9.25 9.5C9.25 8.80964 9.80964 8.25 10.5 8.25C11.1904 8.25 11.75 8.80964 11.75 9.5C11.75 10.1904 11.1904 10.75 10.5 10.75C9.80964 10.75 9.25 10.1904 9.25 9.5ZM12.25 12.5C12.25 11.8096 12.8096 11.25 13.5 11.25C14.1904 11.25 14.75 11.8096 14.75 12.5C14.75 13.1904 14.1904 13.75 13.5 13.75C12.8096 13.75 12.25 13.1904 12.25 12.5Z" fill="currentColor"></path>
                </svg>
              </span>
              <span class="nav-label">Accesos</span>
            </a>
            <a routerLink="/profile" routerLinkActive="active" *ngIf="hasModule('profile')">
              <span class="nav-icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M10.4858 3.5L13.5182 3.5C13.9233 3.5 14.2518 3.82851 14.2518 4.23377C14.2518 5.9529 16.1129 7.02795 17.602 6.1682C17.9528 5.96567 18.4014 6.08586 18.6039 6.43667L20.1203 9.0631C20.3229 9.41407 20.2027 9.86286 19.8517 10.0655C18.3625 10.9253 18.3625 13.0747 19.8517 13.9345C20.2026 14.1372 20.3229 14.5859 20.1203 14.9369L18.6039 17.5634C18.4013 17.9142 17.9528 18.0344 17.602 17.8318C16.1129 16.9721 14.2518 18.0471 14.2518 19.7663C14.2518 20.1715 13.9233 20.5 13.5182 20.5H10.4858C10.0804 20.5 9.75182 20.1714 9.75182 19.766C9.75182 18.0461 7.88983 16.9717 6.40067 17.8314C6.04945 18.0342 5.60037 17.9139 5.39767 17.5628L3.88167 14.937C3.67903 14.586 3.79928 14.1372 4.15026 13.9346C5.63949 13.0748 5.63946 10.9253 4.15025 10.0655C3.79926 9.86282 3.67901 9.41401 3.88165 9.06303L5.39764 6.43725C5.60034 6.08617 6.04943 5.96581 6.40065 6.16858C7.88982 7.02836 9.75182 5.9539 9.75182 4.23399C9.75182 3.82862 10.0804 3.5 10.4858 3.5ZM13.5182 2L10.4858 2C9.25201 2 8.25182 3.00019 8.25182 4.23399C8.25182 4.79884 7.64013 5.15215 7.15065 4.86955C6.08213 4.25263 4.71559 4.61859 4.0986 5.68725L2.58261 8.31303C1.96575 9.38146 2.33183 10.7477 3.40025 11.3645C3.88948 11.647 3.88947 12.3531 3.40026 12.6355C2.33184 13.2524 1.96578 14.6186 2.58263 15.687L4.09863 18.3128C4.71562 19.3814 6.08215 19.7474 7.15067 19.1305C7.64015 18.8479 8.25182 19.2012 8.25182 19.766C8.25182 20.9998 9.25201 22 10.4858 22H13.5182C14.7519 22 15.7518 20.9998 15.7518 19.7663C15.7518 19.2015 16.3632 18.8487 16.852 19.1309C17.9202 19.7476 19.2862 19.3816 19.9029 18.3134L21.4193 15.6869C22.0361 14.6185 21.6701 13.2523 20.6017 12.6355C20.1125 12.3531 20.1125 11.647 20.6017 11.3645C21.6701 10.7477 22.0362 9.38152 21.4193 8.3131L19.903 5.68667C19.2862 4.61842 17.9202 4.25241 16.852 4.86917C16.3632 5.15138 15.7518 4.79856 15.7518 4.23377C15.7518 3.00024 14.7519 2 13.5182 2ZM9.6659 11.9999C9.6659 10.7103 10.7113 9.66493 12.0009 9.66493C13.2905 9.66493 14.3359 10.7103 14.3359 11.9999C14.3359 13.2895 13.2905 14.3349 12.0009 14.3349C10.7113 14.3349 9.6659 13.2895 9.6659 11.9999ZM12.0009 8.16493C9.88289 8.16493 8.1659 9.88191 8.1659 11.9999C8.1659 14.1179 9.88289 15.8349 12.0009 15.8349C14.1189 15.8349 15.8359 14.1179 15.8359 11.9999C15.8359 9.88191 14.1189 8.16493 12.0009 8.16493Z" fill="currentColor"></path>
                </svg>
              </span>
              <span class="nav-label">Perfil</span>
            </a>
            <div class="nav-group" *ngIf="hasModule('mesas')">
              <a routerLink="/mesas" routerLinkActive="active">
                <span class="nav-icon" aria-hidden="true">
                  <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M3.25 5.5C3.25 4.25736 4.25736 3.25 5.5 3.25H18.5C19.7426 3.25 20.75 4.25736 20.75 5.5V18.5C20.75 19.7426 19.7426 20.75 18.5 20.75H5.5C4.25736 20.75 3.25 19.7426 3.25 18.5V5.5ZM5.5 4.75C5.08579 4.75 4.75 5.08579 4.75 5.5V8.58325L19.25 8.58325V5.5C19.25 5.08579 18.9142 4.75 18.5 4.75H5.5ZM19.25 10.0833H15.416V13.9165H19.25V10.0833ZM13.916 10.0833L10.083 10.0833V13.9165L13.916 13.9165V10.0833ZM8.58301 10.0833H4.75V13.9165H8.58301V10.0833ZM4.75 18.5V15.4165H8.58301V19.25H5.5C5.08579 19.25 4.75 18.9142 4.75 18.5ZM10.083 19.25V15.4165L13.916 15.4165V19.25H10.083ZM15.416 19.25V15.4165H19.25V18.5C19.25 18.9142 18.9142 19.25 18.5 19.25H15.416Z" fill="currentColor"></path>
                  </svg>
                </span>
                <span class="nav-label">Mesas</span>
              </a>
              <div class="nav-subnav">
                <a routerLink="/mesas/configuracion" routerLinkActive="active">Configuración</a>
              </div>
            </div>
            <a routerLink="/menu" routerLinkActive="active" *ngIf="hasModule('menu')">
              <span class="nav-icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M5.5 3.25C4.25736 3.25 3.25 4.25736 3.25 5.5V18.5C3.25 19.7426 4.25736 20.75 5.5 20.75H18.5001C19.7427 20.75 20.7501 19.7426 20.7501 18.5V5.5C20.7501 4.25736 19.7427 3.25 18.5001 3.25H5.5ZM4.75 5.5C4.75 5.08579 5.08579 4.75 5.5 4.75H18.5001C18.9143 4.75 19.2501 5.08579 19.2501 5.5V18.5C19.2501 18.9142 18.9143 19.25 18.5001 19.25H5.5C5.08579 19.25 4.75 18.9142 4.75 18.5V5.5ZM6.25005 9.7143C6.25005 9.30008 6.58583 8.9643 7.00005 8.9643L17 8.96429C17.4143 8.96429 17.75 9.30008 17.75 9.71429C17.75 10.1285 17.4143 10.4643 17 10.4643L7.00005 10.4643C6.58583 10.4643 6.25005 10.1285 6.25005 9.7143ZM6.25005 14.2857C6.25005 13.8715 6.58583 13.5357 7.00005 13.5357H17C17.4143 13.5357 17.75 13.8715 17.75 14.2857C17.75 14.6999 17.4143 15.0357 17 15.0357H7.00005C6.58583 15.0357 6.25005 14.6999 6.25005 14.2857Z" fill="currentColor"></path>
                </svg>
              </span>
            ...
            <div class="topbar-user">
              <button class="btn btn-ghost btn-sm" type="button" (click)="toggleTheme()" aria-label="Cambiar tema">
                <span class="theme-icon" aria-hidden="true">
                  <svg *ngIf="theme === 'dark'; else lightThemeIcon" width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true">
              ...
              <button class="btn btn-ghost btn-sm" type="button" (click)="logout()" aria-label="Salir del sistema">
                <span class="theme-icon" aria-hidden="true">
                  <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M15.1007 19.247C14.6865 19.247 14.3507 18.9112 14.3507 18.497L14.3507 14.245H12.8507V18.497C12.8507 19.7396 13.8581 20.747 15.1007 20.747H18.5007C19.7434 20.747 20.7507 19.7396 20.7507 18.497L20.7507 5.49609C20.7507 4.25345 19.7433 3.24609 18.5007 3.24609H15.1007C13.8581 3.24609 12.8507 4.25345 12.8507 5.49609V9.74501L14.3507 9.74501V5.49609C14.3507 5.08188 14.6865 4.74609 15.1007 4.74609L18.5007 4.74609C18.9149 4.74609 19.2507 5.08188 19.2507 5.49609L19.2507 18.497C19.2507 18.9112 18.9149 19.247 18.5007 19.247H15.1007ZM3.25073 11.9984C3.25073 12.2144 3.34204 12.4091 3.48817 12.546L8.09483 17.1556C8.38763 17.4485 8.86251 17.4487 9.15549 17.1559C9.44848 16.8631 9.44863 16.3882 9.15583 16.0952L5.81116 12.7484L16.0007 12.7484C16.4149 12.7484 16.7507 12.4127 16.7507 11.9984C16.7507 11.5842 16.4149 11.2484 16.0007 11.2484L5.81528 11.2484L9.15585 7.90554C9.44864 7.61255 9.44847 7.13767 9.15547 6.84488C8.86248 6.55209 8.3876 6.55226 8.09481 6.84525L3.52309 11.4202C3.35673 11.5577 3.25073 11.7657 3.25073 11.9984Z" fill="currentColor"></path>
                  </svg>
                </span>
              </button>
...
export class AppComponent implements OnInit {
  ...
  moduleAccess = signal<ModuleAccess[]>([]);
  ...
  /**
   * Indica si un módulo está habilitado para el rol actual.
   *
   * @param key llave del módulo.
   */
  hasModule(key: string): boolean {
    const modules = this.moduleAccess();
    if (modules.length === 0) {
      return true;
    }
  ...
  private loadModules() {
    this.moduleAccessService
      .getModulesForCurrentRole()
      .pipe(takeUntilDestroyed(this.destroyRef))
      .subscribe({
        next: (modules) => this.moduleAccess.set(modules),
        error: () => this.moduleAccess.set([])
      });
  }
}
