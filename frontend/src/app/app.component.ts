    ...
    <ng-container *ngIf="isAuthenticated(); else authOnly">
      <div class="app-shell" [class.sidebar-collapsed]="isSidebarCollapsed">
        <aside class="sidebar">
          ...
          <nav class="nav">
            <a routerLink="/dashboard" routerLinkActive="active" *ngIf="canAccess(adminRoles)">
            ...
            <a routerLink="/users" routerLinkActive="active" *ngIf="canAccess(adminRoles)">
              <span class="nav-icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
...
export class AppComponent implements OnInit {
  ...
  adminRoles = ['SUPERADMINISTRADOR', 'ADMINISTRADOR'];
