          ...
          <tbody>
            <tr *ngFor="let mesa of mesas">
              ...
              <td class="text-right">
                ...
                <button class="btn btn-ghost btn-sm icon-btn" type="button" (click)="toggleActive(mesa)" [disabled]="!isSuperadmin" [title]="mesa.activo ? 'Inactivar' : 'Activar'" [attr.aria-label]="mesa.activo ? 'Inactivar' : 'Activar'">
                  <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
                ...
                <button class="btn btn-ghost btn-sm icon-btn" type="button" (click)="deleteMesa(mesa)" title="Eliminar" aria-label="Eliminar">
                  <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
